\chapter{Presentazione Corso} % Introduzione 00
...
\item Reti e IP                                                 % capitolo 2

\item Hacking in una infrastrutture di rete       % capitolo 3

\item Tipi di attacchi                                          % capitolo 4

\item Tecniche di mitigazione                                   % capitolo 5

\item Authentication, authorization, accounting: AAA            % capitolo 6

\item Tecniche di firewalling \index{firewall}                  % capitolo 7

\item Intrusion detection (ids) \index{ids} e prevention (ips) \index{ips}  % capitolo 8

\item Metodi per garantire riservatezza e integrità dei dati    % capitolo 9

\item Raccolta di informazioni e scanning                       % capitolo 10

\item Sfruttare la cattiva amministrazione del sistema          % capitolo 11

\item Rilevazione delle vulnerabilità \index{vulnerabilità}     % capitolo 12

\item Sfruttamento delle vulnerabilità per accedere ai sistemi  % capitolo 13

\item Servizi di cifratura \index{cifratura} simmetrica e asimmetrica   % capitolo 14

\item Hardening dei sistemi                                 % capitolo 15

\item Introduzione alle virtual private networks.               % capitolo 16

\item Computer Hacking Forensics Investigation.               % capitolo 17
